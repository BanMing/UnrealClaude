    ...
    virtual FMCPToolInfo GetInfo() const override
    {
        ...
        Info.Parameters = {
            FMCPToolParameter(TEXT("operation"), TEXT("string"),
                TEXT("Operation: create_widget | set_widget_properties | delete_widget | reparent_widget | save_asset"), true),
            ...
            FMCPToolParameter(TEXT("widget_name"), TEXT("string"),
                TEXT("FName for the new widget, or target widget for set/delete/reparent"), false),
